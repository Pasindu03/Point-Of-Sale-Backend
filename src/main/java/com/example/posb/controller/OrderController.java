...
import com.example.posb.persistance.OrderDetail;
import com.example.posb.persistance.OrderDetailProcess;
...
public class OrderController extends HttpServlet {
    ...
    public boolean purchaseOrder(Connection connection, CombineDto combineDTo){
        try {
            ...
            OrderDto dto = new OrderDto(combineDTo.getOrderId(), combineDTo.getOrderDate(), combineDTo.getCustomerId());
